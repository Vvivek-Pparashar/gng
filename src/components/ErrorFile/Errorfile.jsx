    ...
    return (
        <div className="error">
            ...
            <div className="container">
                <div className="gif">
                    <h1 className="error404-numb2">4<span style={{color:"red"}}>O</span>4</h1>
                    <p className="font-poppins">
                        <b>Oh no, youve found our junior developers homepage!</b>
                    </p>
                    {/* <h1 className="erro404-numb2">4<span>0</span>4</h1> */}
                </div>
                ...
                <div className="button">
                    <button><Link className="Link" to={"/"}>Go To GnG</Link></button>
                </div>
            </div>
                ...
                <div className="font-poppins">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <a className="a-blue" href="contact">Help Center</a>
                        </li>
                        <li>
